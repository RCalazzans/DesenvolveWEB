...
<body>
    ...
    // }
    echo $num = ($num < 20) ? "O número $num é menor que 20" : (($num > 20) ? "O número $num é maior que 20" :
...
do {
    echo $i . " | ";
    $i++;
} while ($i == 0); // Condição falsa, mas executou o codigo uma vez
